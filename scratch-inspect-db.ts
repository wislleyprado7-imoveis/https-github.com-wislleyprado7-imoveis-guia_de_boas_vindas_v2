...
const url = process.env.VITE_SUPABASE_URL || "https://fkjqpuqyxkvbhlagvfvo.supabase.co";
const key = process.env.VITE_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZranFwdXF5eGt2YmhsYWd2ZnZvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODI1NTUwOTMsImV4cCI6MjA5ODEzMTA5M30.WObxMXRy2UEPllzv6S7CEYRzoA_wWVDEGJM3yumt1xo";
